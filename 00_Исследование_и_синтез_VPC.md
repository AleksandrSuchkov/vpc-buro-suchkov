...
- Зависимость застройщиков от агентского канала достигла **85–90%** сделок (норма 45–55%) — продажи «вскрыли» слабость собственных отделов. [GMK / Разуваев, 25.06.2026](https://t.me/razuvaevgmk/2145)
...
- Управлять «по цифрам, а не тушить пожары»; снизить зависимость от агентского канала.
...
**PAINS:** «лиды есть — конверсии нет», «больше лидов ≠ больше продаж», 60–70% лидов холодные; «89% застройщиков не перезвонили»; конверсия в целевой лид упала 44%→32%; ипотечная воронка сломана (одобряют ⅓ заявок, отказ 60% по рыночной); зависимость от агентов 85–90%.
...
→ *Снимает боль:* «27% выполнили план», зависимость от агентов 85–90%, слабый отдел продаж, сломанная ипотечная воронка.
...
5. **«Выполнение плана продаж +»** (флагман) — *собственник + коммерческий.*
   ...
   *Боль:* «27% выполнили план», зависимость от агентов. *Аргумент:* план из гипотез → в управляемые решения с прогнозом эффекта.
...
2. Стратегия баланса — флагман «Выполнение плана продаж»: возврат к 45–55%, паритет условий, отдельные воронки.
...
**Честный баланс:** не убивать канал, а сделать управляемым и лояльным, параллельно усиливая свой отдел; привязка к проекту (эксклюзив-уровни, материалы, обучение), а не голая комиссия.

## 9. Источники (выборка; полный список — в отчётах исследования)
