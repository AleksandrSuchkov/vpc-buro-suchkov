...
**PAINS:** «лиды есть — конверсии нет», «больше лидов ≠ больше продаж», 60–70% лидов холодные; «89% застройщиков не перезвонили»; конверсия в целевой лид на рынке ~32% (норма 35–40%); ипотечная воронка сломана (одобряют ⅓ заявок, отказ 60% по рыночной); до 85–90% сделок через агентов (в среднем по рынку ~65%) — каналом сложно управлять без системы.
...
- **Ляшенко** — «Рынок жилищного строительства РФ»: запуски 16,2 млн м² (5 мес. 2026, −12% г/г); доля ипотеки в ДДУ 65,5%→56% [офиц. ДОМ.РФ по штукам: 76%→68% за 2024→2025], за наличные/рассрочку 27%→34%.
...
- **Александр Торичко** (Artsofte) — «Усилить лидоген / потребитель 2026»: конверсия в целевой лид 44%→32% [в публикациях Artsofte 44% и 32–33% — раздельные кейсовые метрики (ПромоСтраницы/Авито), не рыночный тренд «за год»]; 60% сессий с AI-ответом без перехода на сайт; AI-трафик ×4 конверсия; «больше бюджета ≠ больше готовых к покупке клиентов».
